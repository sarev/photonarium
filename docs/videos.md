...
When you select a video, the bottom panel shows its scenes as a horizontal strip of keyframe thumbnails. Each scene is **proportionally sized by duration** -- a 30-second scene takes up more space than a 5-second scene -- giving you an intuitive sense of the video's structure at a glance.
